<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/php/controller.brocanteurs.php'; ?>
<!DOCTYPE html>
<html lang="fr">
<?php $title = "Brocanteurs"; include_once $_SERVER['DOCUMENT_ROOT'] . '/inc/head.inc.php'; ?>
<body>
    ...
    <main id="Brocanteurs" class="max-width">
        ...
        <section id="Brocanteurs_list" class="boite">
            ...
            if (empty($_GET) || empty($_GET["zone"]) && empty($_GET["search"])) {
                include_once $_SERVER['DOCUMENT_ROOT'] . '/inc/brocanteursList.inc.php';
            } else {
                include_once $_SERVER['DOCUMENT_ROOT'] . '/inc/brocanteursFilteredList.inc.php';
            }
            ?>
        </section>
