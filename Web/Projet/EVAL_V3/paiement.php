<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/php/controller.paiement.php'; ?>
<!DOCTYPE html>
<html lang="fr">
<?php $title = "paiement"; include_once $_SERVER['DOCUMENT_ROOT'] . "/inc/head.inc.php"; ?>
<body>
    ...
    <main class="max-width">
        ...
        <?php if(isset($_GET['inscription'])){ ?>
            <section class="boite" style="background-color: #c4f7c1;margin-bottom: 2.5em;">
        ...
        <section class="boite">
            ...
            <form action="<?= nettoyage_to_db($_SERVER['PHP_SELF']) ?>" method="post">
                <button type="submit" name="paiement" style="margin-top: 2em; background-color: #c4f7c1;">Ok, J'ai payé</button>
            </form>
        </section>
    </main>
