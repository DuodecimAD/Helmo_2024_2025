<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/php/controller.inscription.php'; ?>
<!DOCTYPE html>
<html lang="fr">
<?php $title = "Inscription"; include_once $_SERVER['DOCUMENT_ROOT'] . '/inc/head.inc.php'; ?>
<body>
    ...
    <main class="max-width">
        ...
        <?php if($emplacementsTaken >= MAX_EMPLACEMENTS){ ?>
            <section class="boite" style="background-color: #e8877a">
                <p>"Les inscriptions sont cloturées, tous les emplacements ont été attribués."</p>
            </section>
        <?php } else { ?>

            <form action="<?php echo nettoyage_to_db($_SERVER['PHP_SELF']) ?>" enctype="multipart/form-data" method="post" id="inscription_form" class="boite">
