<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/php/controller.login.php'; ?>
<!DOCTYPE html>
<html lang="fr">
<?php $title = "Me connecter"; include_once $_SERVER['DOCUMENT_ROOT'] . '/inc/head.inc.php'; ?>
<body>
    <?php include_once $_SERVER['DOCUMENT_ROOT'] . '/inc/header.inc.php'; ?>

    <main class="max-width">
        <h1>Me connecter</h1>
        <form action="<?php echo nettoyage_from_db($_SERVER['PHP_SELF']) ?>" method="post" id="login_form" class="boite" style="position: relative;">
            <div>
            ...
            <div id="loginHelp" style="line-height: 2em;">
