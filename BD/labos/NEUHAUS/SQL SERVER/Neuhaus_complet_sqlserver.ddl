...
create table Message (
     ...
     date_message smalldatetime not null,
...
create table Bien (
     ...
     date_mise_en_vente smalldatetime not null,
     id_client numeric(10) not null,
     id_catsituation numeric(10) not null,
     id_catetat numeric(10) not null,
     id_catcuisine numeric(10) not null,
...
create table Historique_prix (
     id_prix numeric(10) not null,
     montant numeric(10,2) not null,
     date_prix smalldatetime not null,
     id_bien numeric(10) not null,
...
create table Offre (
     ...
     montant numeric(10,2) not null,
     date_offre smalldatetime not null,
